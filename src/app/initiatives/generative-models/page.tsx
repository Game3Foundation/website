		...
		<div className="py-12 px-4">
			<div className="max-w-4xl mx-auto">
				<CardHeader className="text-center">
					<CardTitle className="text-4xl font-medium mb-4">Generative Models</CardTitle>
				...
				<CardContent>
					<div className="space-y-8 mt-8">
						<div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
							<h3 className="text-xl font-medium mb-2">Procedural Generation</h3>
						...
						<div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
							<h3 className="text-xl font-medium mb-2">Content Creation Tools</h3>
							<p className="text-gray-300">
						...
						<div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
							<h3 className="text-xl font-medium mb-2">Dynamic Storytelling</h3>
							<p className="text-gray-300">
						...
						<div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
							<h3 className="text-xl font-medium mb-2">Unity3D Integration</h3>
							<p className="text-gray-300">
